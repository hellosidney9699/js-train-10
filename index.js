...
function customAssign(...objects) {
  ...
  for (let key in object) {
    ...
    if (typeof value === "number") {
      object[key] = String(value).replace(/ /g, "_");
    }
  }
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  let extendedObj = Object.assign({}, obj1, obj2);
  Object.freeze(extendedObj);
  if (Object.isFrozen(extendedObj)) {
    return extendedObj;
  } else {
    return "Помилка: Об'єкт не був заморожений.";
  }
